...
export default async function mint(req: NextApiRequest, res: NextApiResponse) {
  ...
  const address = await mainnetProvider.resolveName(body["address"]);
  ...
  const result = await nftModule.mintTo(address, {
    image:
      "https://nftlabs.mypinata.cloud/ipfs/bafkreigujah2nr7hckyqxvlnllfoxvhopmkawyemb3c2hjg7v2luysh67m",
